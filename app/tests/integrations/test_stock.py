...
@pytest.mark.asyncio
async def test_get_exchange_tickers_non_yahoo_single_exchange(db_session,stock_repo,stock_data):
...
@pytest.mark.asyncio
async def test_get_exchange_tickers_no_yahoo_multiple_exchange(async_engine,stock_repo,stock_data):
...
@pytest.mark.asyncio
async def test_get_exchange_tickers_multiple_exchange(async_engine,stock_repo,stock_data):
