...
@pytest.mark.asyncio
async def test_get_stock_exchange(db_session, stock_exchange_repo):
...
@pytest.mark.asyncio
async def test_get_stock_exchange_index(db_session, stock_exchange_indexes_repo):
...
async def test_get_stock_exchange_indexes_for_stock_market(
    ...
    indexes = await stock_exchange_indexes_repo.get_exchange_indexes(
        stock_exchange="GPW"
    )
